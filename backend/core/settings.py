...
CKEDITOR_UPLOAD_PATH = os.path.join(BASE_DIR, 'backend/media')
...
BANK_API_KEY = env('BANK_API_KEY', default=None)

if not DEBUG:
    DEFAULT_FROM_EMAIL = 'Plataforma Educativa AI <nombre@jefe.com>'
